...
#Description: This script mege the openSNP datasets of *.bed, *.bim, *.fam files processed produced by  plink. 
    ...
    my $First_File="23andme01";                        # As first seed file for date merge.
    ...
    while (my $file = readdir(DIR)) {
    	...
    	if ($file=~m/bed$/){       
       	...
       	$File_Name=$file;
       	$File_Name=~s/bed$//; # Get the filename for reformating to get absolutely dir of *.bed, *.bim, and *.fam files.
       	#print "****** $File_Name\n";
